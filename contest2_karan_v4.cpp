...
{
    std::string s = raw;
    // Remove trailing newlines/spaces YOLO might append
    ...
    if (start != std::string::npos) {
        ...
        return ""; // String was purely whitespace
    }
    ...
    while (rclcpp::ok() && secondsElapsed <= 300) {
        ...
        switch (current_state) {
            ...
            case RobotState::NAVIGATE_TO_SCENE: {
                ...
                double standoff_dist = 0.05; // Stop 0.5m in front of the object, reduced standoff distance from 0.5 to 0.05
