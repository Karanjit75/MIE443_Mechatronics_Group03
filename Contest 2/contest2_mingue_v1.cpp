...
int main(int argc, char** argv) {
    ...
    std::vector<double> manipulable_object_rel_pos = {,,,,,};
        ...
        switch(current_state) {
            ...
            case RobotState::SCAN_MANIPULABLE_OBJECT: {
                ...
                for (int i = -10; i < 10; i++) {
                    ...
                    armController.moveToCartesianPose(manipulable_object_rel_pos[0]+0.005*i,
                                                        manipulable_object_rel_pos[1]+0.005*i,
                                                        manipulable_object_rel_pos[2]+0.005*i,
            ...
            case RobotState::NAVIGATE_TO_SCENE: {
                if (current_target_index < total_targets) {
                    ...
                    bool reached_goal = nav.moveToGoal(goal_x, goal_y, goal_phi);
            ...
            case RobotState::DETECT_OBJECT: {
                ...
                std::string detected_item = yoloDetector.getObjectName(CameraSource::OAKD, true);                
            ...
            case RobotState::CHANGE_PERSPECTIVE: {
                ...
                bool back_up = nav.moveToGoal(reference_coordinate[0]-0.5*cos(reference_coordinate[2]+M_PI), 
                ...
                if (back_up) {
                    ...
                    if (!detected_item.empty()) {
                        ...
                        if (valid_objects.count(detected_item) && confidence > 0.5) {
                            ...
                            discovered_scene_objects.push_back(detected_item);
                            discovered_object_confidence.push_back(confidence);
                            bool back = nav.moveToGoal(reference_coordinate[0], reference_coordinate[1], reference_coordinate[2]);
            ...
            case RobotState::LOCATE_DISCARD: {
                ...
                if (!visible_tags.empty()) {
                    ...
                    if (tag_pose_opt.has_value()) {
                        ...
                        armController.moveToCartesianPose(bin_x, bin_y, bin_z + 0.15, , ,);
                        armController.openGripper();
                        current_state = RobotState::RETURN_TO_START;
                    }
                }
            ...
            case RobotState::RETURN_TO_START: {
                ...
                bool returned = nav.moveToGoal(start_pose[0], start_pose[1], start_pose[2]); 
                if (returned) {
